...
namespace ValoPlayBook.Data.Data
{
    public static partial class DbInitializer
    {
        private static void SeedDefaults(AppDbContext context)
        {
            ...
            var boomBotRaze = context.Abilities.FirstOrDefault(a => a.Name == "Boom Bot" && a.AgentId == raze.Id);
            var nanoswarmKilljoy = context.Abilities.FirstOrDefault(a => a.Name == "Nanoswarm" && a.AgentId == killjoy.Id);
            var trapwireCypher = context.Abilities.FirstOrDefault(a => a.Name == "Trapwire" && a.AgentId == cypher.Id);
            var hauntFade = context.Abilities.FirstOrDefault(a => a.Name == "Haunt" && a.AgentId == fade.Id);
